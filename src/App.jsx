...
const ROLE_TABS = {
  admin:       ["home","obras","orc","plan","rdo","med","est","cmp","ponto","equipe","terc","folha","resc","dre_emp","dre","fin","conc","medicoes","caixa","relat","ia","cad","config"],
  engenheiro:  ["home","obras","orc","plan","rdo","med","est","cmp","ponto","equipe","terc","caixa","cad","ia"],
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    tabs: ["obras", "orc", "plan", "rdo", "med", "ponto", "equipe", "terc", "est", "cmp"],
  },
  {
...
const TAB_META = {
  ...
  rdo:    { label: "Diario de obra", icon: "file",   group: "obras_grp"},
  med:    { label: "Medicao",        icon: "chart",  group: "obras_grp"},
