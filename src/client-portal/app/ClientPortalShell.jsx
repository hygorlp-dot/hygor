...
export function ClientPortalShell({ project, active, permissions, children, onNavigate }) {
  ...
  return <div className="arcd-client-shell"><ClientPortalHeader project={project} onOpenMore={() => setMoreOpen(true)} /><main className="arcd-client-content">{children}</main><ClientPortalBottomNav active={active} permissions={permissions} onNavigate={navigate} /><ClientPortalMoreMenu open={moreOpen} onOpenChange={setMoreOpen} onNavigate={onNavigate} /></div>;
}
