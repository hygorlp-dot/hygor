...
const [docForm,setDocForm]=useState({nome:"",url:""});
  ...
  if(commercialView==="com_dash"){
    ...
    const filtrados=view==="com_reunioes"?itens.filter(x=>x._tipo==="reuniao"):view==="com_tarefas"?itens.filter(x=>x._tipo==="atividade"):(calDia?itens.filter(x=>(x.dataHora||"").slice(0,10)===calDia):itens);
    ...
    {view==="com_agenda"&&calDia&&<div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
