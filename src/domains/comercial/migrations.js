...
export const migrateCommercial=(commercial={})=>{
  if(Number(commercial.schemaVersion||0)>=COMMERCIAL_SCHEMA_VERSION)return commercial;
  ...
  return {...commercial,schemaVersion:COMMERCIAL_SCHEMA_VERSION,leads:migratedLeads,opportunities,stageEvents};
};
